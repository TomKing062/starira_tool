...
start chrome.exe https://karth.top/dress/%%i?global=1
start chrome.exe https://karth.top/api/adventure/ww/30%%i1.json
start chrome.exe https://karth.top/api/adventure/ww/30%%i2.json
start chrome.exe https://karth.top/api/adventure/ww/31%%i1.json
start chrome.exe https://karth.top/api/adventure/ww/31%%i2.json
)
