...
for /f %%i in ('type emulator_share\strr_banner.txt') do (start https://cdn.starira.xyz/api/assets/jp/res_ja/res/banner/%%i)
for /f %%i in ('type emulator_share\strr_event.txt') do (start https://cdn.starira.xyz/api/assets/jp/res_ja/res/event_permanent/banner/%%i)
for /f %%i in ('type emulator_share\strr_gacha.txt') do (start https://cdn.starira.xyz/api/assets/jp/res_ja/res/gacha/background/%%i)
